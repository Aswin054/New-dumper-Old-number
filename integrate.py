...
# Load CSV files
features_path = r"C:\Users\Lenova\Desktop\new dumper ON\features.csv"
predictions_path = r"C:\Users\Lenova\Desktop\new dumper ON\predictions.csv"
...
model_path = r"C:\Users\Lenova\Desktop\new dumper ON\models\model.pkl"
...
license_plate_model = YOLO(r'C:\Users\Lenova\Desktop\new dumper ON\models\license_plate_detector.pt')  # Replace with actual path
...
if truck_type == "New" and number_plate_type == "Old":
    print("\033[91mNEW DUMPER WITH OLD NUMBER 🚨\033[0m")  # Red color warning
